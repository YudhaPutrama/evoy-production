...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <br><h3 class="page-header">Asal Pakaian : Pulau <?php echo $rows->ASAL_DAERAH_PAKAIAN; ?>, Provinsi <?php echo $rows->ASAL_PROV; ?></h3>
            </div>
        </div>
        <!-- /.row -->
		...
		<?php 
			if (isset($_SESSION['username'])){
				$id=$_SESSION['username'];
				$idp=$_GET['kode_pakaian'];
				$m = oci_parse($conn,"select stok from pakaian where kode_pakaian = '$idp'");
				oci_execute($m);
		...
		<div id="pinjam">
			...
			?>
			<div id='button' ><a href='#' >Pinjam</a></div>
			<?php
				}
			?>
		</div>
				...
				<a href="#" class="close-button" title="Close">X</a>
					<form action="#popup2" method="post">
						<div id="isidata">
							...
							Nama  <input type="text" placeholder="Nama Anda..." name="nama"value="<?php echo $rows->NAMA; ?> " required/><br><br>
							No.HP <input type="text" placeholder="No.HP anda..." name="hp" value="<?php echo $rows->NO_HP; ?>" required/><br><br>
							Alamat<textarea name="alamat" placeholder="Alamat anda..." required><?php echo $rows->ALAMAT; ?></textarea><br><br>
				...
				<div id="imghold">	
					<?php 
						...
						while($rows=oci_fetch_object($gmr)){
							echo "<img src='pages/gambar/".$rows->GAMBAR."' width='260px' height='200px'/>"; 
						}
					?>					
				</div>
					<form action="#popup3" method="post">
						...
						<div id="jml">
							<select name='jml'required>
								<option value ="" disabled="disabled" selected="selected">Jumlah Pakaian</option>
								<?php
									$idg = $_GET['kode_pakaian'];
						...
						<div id="krr">
							<select name = 'krr' required>
								<option value="" disabled="disabled" selected="selected">Kurir</option>
						...
						<div id="lama">
							<select name='lama' required>
								<option value="" disabled="disabled" selected="selected">Lama Pinjam</option>
						...
						<div id="capacc">
							...
							<input type="radio" name="acc"  value ="Tidak" checked="checked">Tidak
						</div>
						<div id="capket">
							Keterangan
						</div>
		...
		<div id="popup3">
			<div class="window3">
				...
				<p> Silahkan Transfer Ke : xxxxxxxxxxx <br>
					...
					(Proses akan dibatalkan jika tidak melakukan pembayaran dalam waktu 1 x 24 jam)<br>
					Setelah Anda Melakukan Pembayaran Silahkan Upload Bukti Transfer di Transaksiku lalu Detail.
				</p>
			</div>
		</div>
		<?php
