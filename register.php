					...
					<br><br><br><br>
						<div class="login-panel panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title"><center>Silahkan Daftar Sesuai dengan KTP Anda</center></h3>
							</div>
							<div class="panel-body">
							   <form method="post" style="margin-top:0px; width:420px;" action="prosesdaftar.php">
									...
									<input type="password" name="pass1" class="form-control" placeholder="Masukkan Password" required><br>
									<input type="text" name="ktp" class="form-control" placeholder="Masukkan No KTP" required><br>
									<input type="text" name="tgllahir" class="form-control" placeholder="Tempat Tanggal Lahir" required><br>
									Jenis Kelamin : &nbsp &nbsp &nbsp
									<input type="radio" name="gender"  value ="Perempuan"  required>Perempuan &nbsp &nbsp &nbsp
									<input type="radio" name="gender"  value ="Laki-Laki" />Laki-Laki </font><br><br>
									<input type="text" name="nohp"  class="form-control" placeholder="Masukkan No HP" required><br>
									<textarea name="alamat" rows="2" cols="10" class="form-control" placeholder="Masukan Alamat" required></textarea><br>
