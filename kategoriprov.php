    ...
    <div class="container"  style="background-image: url(/batikbg.png');">
        <div class="row">
			...
			?>
				...
				<br>
                <p class="lead"> <?php echo $_GET['prov']; ?></p>
                <div class="list-group">
				<?php 
					echo "<a href='kategori.php?asal=$asal' class='list-group-item'>Kembali</a>";
				?>	
                </div>
			...
			<?php
				...
				$prov=$_GET['prov'];
				if(!isset($_POST['key'])){
					$query= oci_parse($conn,"Select * from pakaian where asal_daerah_pakaian='$asal' AND asal_prov ='$prov' order by dbms_random.value");
					$a = oci_parse($conn,"select count(kode_pakaian) as jmlpakaianprov from pakaian where asal_daerah_pakaian='$asal' AND asal_prov='$prov'");
				}else{
					$key = $_POST['key'];
					$query= oci_parse($conn,"Select * from pakaian where asal_daerah_pakaian='$asal' AND asal_prov ='$prov' and upper(nama_pakaian) like upper('%$key%')");
					$a = oci_parse($conn,"select count(kode_pakaian) as jmlpakaianprov from pakaian where asal_daerah_pakaian='$asal' AND asal_prov='$prov' and upper(nama_pakaian) like upper('%$key%')");
				}
				oci_execute($query);
				oci_execute($a);
				$s = oci_fetch_assoc($a);
