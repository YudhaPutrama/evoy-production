        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                    <div class="col-lg-6">
						...
						<form method="post" action="viewpakaian.php" enctype="multipart/form-data">
						
							
                                <input type="text" class="form-control" placeholder="Kode Pakaian" name="KODE_PAKAIAN"><br>
                                <input type="text" class="form-control" placeholder="Nama Pakaian" name="namapk"><br>
                                ...
                                <textarea class="form-control" rows="3" name="desk"></textarea><br>
                                <input type="number" class="form-control" placeholder="Stok" name="stok"><br>
                                <input type="number" class="form-control" placeholder="Harga" name="harga"><br>
								<label>Masukkan Gambar Pakaian</label>
