            ...
            <div class="row">
                    <div class="col-lg-6">
						<form enctype="multipart/form-data">
							<?php
								$id = $_GET['idpesan'];
								$psn = oci_parse($conn,"select*from pesan where id_pesan='$id'");
								oci_execute($psn);
								while($rows=oci_fetch_object($psn)){
							?>
							<div align="right"><b><i><?php echo date("d F Y",strtotime($rows->TANGGAL));?></i></b></div><br>
							<label>Nama Pengirim</label>
							<input type="text" value="<?php echo $rows->NAMA_PENGIRIM;?>" class="form-control" disabled><br>
							<label>Email Pengirim</label>
							<input type="text" value="<?php echo $rows->EMAIL_PENGIRIM;?>" class="form-control" disabled><br>
							<label>Nomor HP Pengirim</label>
							<input type="text" value="<?php echo $rows->NO_HP_PENGIRIM;?>" class="form-control" disabled><br>
							<label>Isi Pesan</label>
							<textarea class="form-control" disabled><?php echo $rows->PESAN;?></textarea><br>
							<?php
								}
							?>
							<input type="submit" value="Kembali" class="btn btn-info">
                        </form>
                    </div>
                </div>
            <!-- /.row -->
