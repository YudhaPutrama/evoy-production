            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lupa kata sandi Anda?</h3>
                    </div>
                    <div class="panel-body">
                        <form class = "form-horizontal" method="post" style="margin-top:0px; width:320px;" action="lupapas.php">
							Silahkan ketik alamat email anda dan kami akan memberitahukan kata sandi anda melalui email tersebut. <br><br>
							<input type="email" name="email" class="form-control" placeholder="Masukkan Email" required data-validation-required-message="Please enter your name."></span><br>
							<input type="submit" class="btn btn-primary btn-block" value="Kirim" name="submit">
						</form>
                    </div>
                </div>
            </div>
